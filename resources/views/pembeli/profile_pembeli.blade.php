            ...
            <main class="container mx-auto p-6 flex space-x-6">
                <aside class="w-64 bg-white shadow-lg rounded-lg p-4">
                    ...
                    <nav class="space-y-2">
                        ...
                        <a href="{{ route('daftar-transaksi') }}" class="block p-3 text-gray-700 rounded-lg font-medium hover:bg-gray-100">Daftar Transaksi</a>
                    </nav>
                </aside>
                ...
                <div class="flex-1 bg-white shadow-lg rounded-lg p-6">
                    <div class="flex flex-col md:flex-row md:space-x-6">
                        ...
                        <div class="md:w-2/3 space-y-4">
                            ...
                            <button type="submit" class="bg-rust text-white px-4 py-2 rounded-lg font-medium hover:bg-rust-dark"><a href="{{ route('edit-profile-pembeli', ['id' => $user->id]) }}">Ubah Biodata</a></button>
                        </div>
