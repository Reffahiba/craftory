    ...
    @section('content')
        ...
        <h1 class="text-3xl font-semibold mt-5 ml-3">Edit Produk</h1>
            ...
            <div class="bg-light-apricot rounded-xl shadow-2xl p-5">
                ...
                <form action="{{ route('produk-update', $produk['id']) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="file" name="foto_produk" id="foto_produk" value="{{ old('foto_produk', $produk->foto_produk) }}" class="block w-full rounded-lg py-2 px-2 border border-gray-300">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_produk" id="nama_produk" value="{{ old('nama_produk', $produk->nama_produk) }}" class="block w-full rounded-lg py-2 px-2 border border-gray-300">
                    ...
                    <div>
                        ...
                        <input type="text" name="deskripsi" id="deskripsi" value="{{ old('deskripsi', $produk->deskripsi) }}" class="block w-full rounded-lg py-2 px-2 border border-gray-300">
                    ...
                    <div>
                        ...
                        <input type="number" name="harga" id="harga" value="{{ old('harga', $produk->harga) }}" class="block w-full rounded-lg py-2 px-2 border border-gray-300">
                    ...
                    <div>
                        ...
                        <input type="number" name="stok" id="stok" value="{{ old('stok', $produk->stok) }}" class="block w-full rounded-lg py-2 px-2 border border-gray-300">
                    ...
                    <div>
                        ...
                        <select name="kategori_id" id="kategori_id" required class="block w-full rounded-lg py-2 px-2 border border-gray-300">
